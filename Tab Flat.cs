...
namespace Project.CustomControls
{
    public class MainTab : TabControl
    {
        ...
        /// </summary>
        private Color activeColor = Color.FromArgb(30, 30, 30);

        /// <summary>
        ///     The color of the background of the Tab
        /// </summary>
        private Color backTabColor = Color.FromArgb(30, 30, 30);
        ...
        /// </summary>
        private Color headerColor = Color.FromArgb(51, 51, 51);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                ...
                if (i == SelectedIndex)
                {
                    ...
                    Drawer.FillRectangle(
                        ...
                        new Rectangle(Header.X - 5, Header.Y - 3, Header.Width, Header.Height + 25));
                    ...
                    if (this.ShowClosingButton)
                    {
                        e.Graphics.DrawString("x", Font, ClosingColorBrush, HeaderSize.Right - 18, 6);
                    }
                }
                else
                {
            ...
            Drawer.DrawLine(new Pen(this.horizLineColor, 1), new Point(0, 19), new Point(Width, 1));
